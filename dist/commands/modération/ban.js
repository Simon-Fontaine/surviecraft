...
exports.default = {
    category: "Modération",
    description: "Bannit l'utilisateur spécifié.",
    minArgs: 2,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        authorId = user.id;
                        if (authorId === id) {
                            return [2 /*return*/, "Vous ne pouvez pas vous bannir vous-même."];
                        }
                        if (target instanceof discord_js_1.GuildMember) {
                            if (!target.bannable) {
                                return [2 /*return*/, "Vous ne pouvez pas bannir cet utilisateur."];
                            }
                            ...
                            if (cache.has(ids_1.default.MODO_ROLE) ||
                                ...
                                return [2 /*return*/, "Vous ne pouvez pas bannir un membre du staff."];
                            }
                        }
                        content = "\u00CAtes-vous s\u00FBr de vouloir bannir <@".concat(id, ">?");
                        components = [
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, channel.send({
                                                content: "<@".concat(authorId, "> vous n'avez pas s\u00E9lectionn\u00E9 une action \u00E0 temps. Veuillez ex\u00E9cuter \u00E0 nouveau la commande de bannissement."),
                                            })];
                                    case 1:
                                        _b.sent();
                                        if (newMessage) {
                                        ...
                                        return [2 /*return*/];
                                    case 2:
                                        content = "\u274C <@".concat(id, "> n'a pas \u00E9t\u00E9 banni.");
                                        if (!(button.customId === "ban_yes")) return [3 /*break*/, 4];
                                        MPembed = new discord_js_1.MessageEmbed()
                                            .setTitle("SurvieCraft - Bannissement")
                                            .setDescription(["Attention, vous \u00EAtes fait ban !", "**Raison:** ".concat(reason)].join("\n"))
                                            .setFields([
                                            {
                                    ...
                                    case 3:
                                        ...
                                        content = "\u2705 <@".concat(id, "> a \u00E9t\u00E9 banni avec succ\u00E8s.");
                                        modLogChannel_1 = guild.channels.cache.get(ids_1.default.MOD_LOGS_CHANNEL);
                                        if (modLogChannel_1) {
                                            embed = new discord_js_1.MessageEmbed()
                                                .setTitle("Utilisateur Banni du Serveur")
                                                .setColor("RED")
