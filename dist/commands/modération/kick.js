...
exports.default = {
    category: "Modération",
    description: "Kick l'utilisateur spécifié.",
    minArgs: 2,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        authorId = user.id;
                        if (authorId === id) {
                            return [2 /*return*/, "Vous ne pouvez pas vous kick vous-même."];
                        }
                        if (target instanceof discord_js_1.GuildMember) {
                            if (!target.kickable) {
                                return [2 /*return*/, "Vous ne pouvez pas kick cet utilisateur."];
                            }
                            cache = target.roles.cache;
                            if (cache.has(ids_1.default.GUIDE_ROLE) ||
                                cache.has(ids_1.default.MODO_ROLE) ||
                                ...
                                return [2 /*return*/, "Vous ne pouvez pas kick un membre du staff."];
                            }
                        }
                        content = "\u00CAtes-vous s\u00FBr de vouloir kick <@".concat(id, ">?");
                        components = [
                            new discord_js_1.MessageActionRow()
                                .addComponents(new discord_js_1.MessageButton().setCustomId("kick_yes").setLabel("Oui").setStyle("SUCCESS"))
                                .addComponents(new discord_js_1.MessageButton().setCustomId("kick_no").setLabel("Non").setStyle("DANGER")),
                        ];
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, channel.send({
                                                content: "<@".concat(authorId, "> vous n'avez pas s\u00E9lectionn\u00E9 une action \u00E0 temps. Veuillez ex\u00E9cuter \u00E0 nouveau la commande de kick."),
                                            })];
                                    case 1:
                                        _b.sent();
                                        if (newMessage) {
                                        ...
                                        return [2 /*return*/];
                                    case 2:
                                        content = "\u274C <@".concat(id, "> n'a pas \u00E9t\u00E9 kick.");
                                        if (!(button.customId === "kick_yes")) return [3 /*break*/, 4];
                                        MPembed = new discord_js_1.MessageEmbed()
                                            .setTitle("SurvieCraft - Sanction")
                                            .setDescription(["Attention, vous \u00EAtes fait kick !", "**Raison:** ".concat(reason)].join("\n"))
                                            .setFields([
                                            {
