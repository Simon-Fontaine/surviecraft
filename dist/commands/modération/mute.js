...
exports.default = {
    category: "Modération",
    description: "Mute l'utilisateur spécifié.",
    slash: "both",
    testOnly: true,
    guildOnly: true,
    options: [
        ...
        {
            name: "duration",
            description: "Indiquer la durée du mute",
            type: "STRING",
            required: true,
        },
        {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var target, argId, id, duration, convertedTime, reason, guild, ignored_1, authorId, cache, content, components, newMessage, filter, collector;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (message) {
                            if (!args[0])
                                return [2 /*return*/, "Spécifier un membre à mute!"];
                            if (!args[1])
                                return [2 /*return*/, "Spécifier une durée pour votre mute! (mute @user 1h raison) (d, h, m et s)"];
                            if (!args[2])
                                return [2 /*return*/, "Spécifier une raison à votre mute!"];
                        }
                        argId = args[0];
                        id = (target === null || target === void 0 ? void 0 : target.id) || argId || "";
                        duration = message ? args[1] : interaction.options.getString("duration");
                        convertedTime = (0, ms_1.default)(message ? args[1] : interaction.options.getString("duration"));
                        reason = (message ? args.slice(2).join(" ") : interaction.options.getString("reason")) || "Aucune raison spécifiée";
                        guild = channel.guild;
                    ...
                    case 4:
                        authorId = user.id;
                        if (authorId === id) {
                            return [2 /*return*/, "Vous ne pouvez pas vous mute vous-même."];
                        }
                        if (target instanceof discord_js_1.GuildMember) {
                            if (!target.moderatable) {
                                return [2 /*return*/, "Vous ne pouvez pas mute cet utilisateur."];
                            }
                            ...
                            if (cache.has(ids_1.default.MODO_ROLE) ||
                                ...
                                return [2 /*return*/, "Vous ne pouvez pas mute un membre du staff."];
                            }
                        }
                        if (!convertedTime) {
                            return [2 /*return*/, "Spécifier une durée valable!"];
                        }
                        content = "\u00CAtes-vous s\u00FBr de vouloir mute <@".concat(id, ">?");
                        components = [
                    ...
                    case 8:
                        ...
                        collector.on("end", function (collected) { return __awaiter(void 0, void 0, void 0, function () {
                            var button, content, str, mapObj, MPembed, modLogChannel_1, embed;
                            var _a;
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, channel.send({
                                                content: "<@".concat(authorId, "> vous n'avez pas s\u00E9lectionn\u00E9 une action \u00E0 temps. Veuillez ex\u00E9cuter \u00E0 nouveau la commande de mute."),
                                            })];
                                    case 1:
                                        _b.sent();
                                        if (newMessage) {
                                        ...
                                        return [2 /*return*/];
                                    case 2:
                                        content = "\u274C <@".concat(id, "> n'a pas \u00E9t\u00E9 mute.");
                                        ...
                                        // @ts-ignore
                                        str = str.replace(/d|h|m|s/gi, function (matched) { return mapObj[matched]; });
                                        MPembed = new discord_js_1.MessageEmbed()
                                            .setTitle("SurvieCraft - Sanction")
                                            .setDescription(["Attention, vous \u00EAtes fait mute !", "**Raison:** ".concat(reason)].join("\n"))
                                            .setFields([
                                            {
                                                name: "Sanction donnée par",
                                                value: "<@".concat(authorId, ">"),
                                                inline: true,
                                            },
                                            {
                                                name: "Durée de la sanction",
                                                value: "".concat(str),
                                                inline: true,
                                            },
                                        ])
