    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                switch (Action) {
                    case "close":
                        ticket_schema_1.default.findOne({ GuildID: guildId, ChannelID: channel.id }, function (err, docs) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!docs)
                                            return [2 /*return*/, interaction.reply({
                                                    embeds: [Embed.setColor("RED").setDescription("⛔ | Ce salon n'est pas un ticket.")],
                                                    ephemeral: true,
                                                })];
                                        if (docs.Closed == true)
                                            return [2 /*return*/, interaction.reply({
                                        ...
                                        modal = new discord_js_1.Modal().setCustomId("closeModal").setTitle("Fermeture du ticket.");
                        ...
                        ticket_schema_1.default.findOne({ GuildID: guildId, ChannelID: channel.id }, function (err, docs) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                ...
                                if (docs.MembersID.includes(Member.user.id))
                                    return [2 /*return*/, interaction.reply({
                                            embeds: [Embed.setColor("RED").setDescription("⛔ | Ce membre est déjà ajouté à ce ticket.")],
                                            ephemeral: true,
                                        })];
                                ...
                                interaction.reply({
                                    embeds: [Embed.setColor("GREEN").setDescription("\u2705 | ".concat(Member, " a \u00E9t\u00E9 ajout\u00E9 \u00E0 ce ticket."))],
                                });
                                docs.save();
                                return [2 /*return*/];
                            });
                    ...
                    case "remove":
                        ...
                        ticket_schema_1.default.findOne({ GuildID: guildId, ChannelID: channel.id }, function (err, docs) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                ...
                                if (!docs.MembersID.includes(Member.user.id))
                                    return [2 /*return*/, interaction.reply({
                                            embeds: [Embed.setColor("RED").setDescription("⛔ | Ce membre n'est pas ajouté à ce ticket.")],
                                            ephemeral: true,
                                        })];
                                ...
                                interaction.reply({
                                    embeds: [Embed.setColor("GREEN").setDescription("\u2705 | ".concat(Member, " a \u00E9t\u00E9 supprim\u00E9 de ce ticket."))],
                                });
                                docs.save();
                                return [2 /*return*/];
                            });
