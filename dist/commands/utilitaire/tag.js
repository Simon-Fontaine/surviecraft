...
exports.default = {
    category: "Utilitaire",
    description: "Affiche un message de tag.",
    minArgs: 1,
    expectedArgs: "<tag>",
    slash: "both",
    testOnly: true,
    ...
    callback: function (_a) {
        var name = _a.text, interaction = _a.interaction, channel = _a.channel;
        return __awaiter(void 0, void 0, void 0, function () {
            var tag;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, tag_schema_1.default.findById(name.toLowerCase())];
                    case 1:
                        tag = _b.sent();
                        if (!tag) {
                            return [2 /*return*/, {
