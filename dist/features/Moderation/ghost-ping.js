...
exports.default = (function (client) {
    ...
    var ghostPingChannel = guild === null || guild === void 0 ? void 0 : guild.channels.cache.get(ids_1.default.MOD_LOGS_CHANNEL);
    var handleMessage = function (message) { return __awaiter(void 0, void 0, void 0, function () {
        var member, content, embed;
        var _a;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    embed = new discord_js_1.MessageEmbed()
                        .setTitle("Possible Ping Fantôme")
                        .setDescription("**Message**\n\"".concat(content, "\""))
                        .setFields([
                        {
                            name: "Channel Du Ping",
                            value: "<#".concat(message.channel.id, ">"),
                            inline: true,
                        },
                        {
                            name: "Auteur Du Ping",
    ...
    client.on("messageDelete", handleMessage);
});
exports.config = {
    dbName: "GHOST_PING",
    displayName: "Ghost Ping",
};
