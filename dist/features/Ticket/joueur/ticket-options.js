                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, ticket_schema_1.default.updateOne({ ChannelID: channel.id }, { Locked: true })];
                        case 2:
                            _b.sent();
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, ticket_schema_1.default.updateOne({ ChannelID: channel.id }, { Locked: false })];
                        case 4:
                            _b.sent();
                        ...
                        case 7:
                            ...
                            return [4 /*yield*/, ticket_schema_1.default.updateOne({ ChannelID: channel.id }, 
                                // @ts-ignore
                                { Claimed: true, ClaimedBy: "".concat(member.user.tag, " (||").concat(member.user.id, "||)") })];
                        case 8:
                            _b.sent();
                            embed.setDescription("\uD83D\uDE4B\u200D\u2642\uFE0F | Ce ticket a \u00E9t\u00E9 pris en charge, vous allez \u00EAtre assist\u00E9 par ".concat(member));
                            interaction.reply({ embeds: [embed] });
                            return [3 /*break*/, 9];
