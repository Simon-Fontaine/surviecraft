...
exports.default = (function (client) {
    client.on("interactionCreate", function (interaction) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (!["staffCloseModal"].includes(customId))
                return [2 /*return*/];
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            _a = customId;
                            switch (_a) {
                                case "staffCloseModal": return [3 /*break*/, 1];
                            }
                            return [3 /*break*/, 9];
                        case 1:
                            if (docs.Closed == true)
                        ...
                        case 2:
                            attachment = _d.sent();
                            return [4 /*yield*/, staff_ticket_schema_1.default.updateOne({ ChannelID: channel.id }, { Closed: true })];
                        case 3:
                            _d.sent();
